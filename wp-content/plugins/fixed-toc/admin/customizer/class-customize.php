...
//			'active_callback'		=> array( $this, 'has_toc_page' )
	...
	public function print_controls_style() {
		echo '<style type="text/css">#customize-control-fixedtoc-field-general_css .CodeMirror-wrap { margin-left: -12px; width: calc(100% + 24px); height: calc( 100vh - 185px ) }</style>';
	}
