                    ...
                    document.onreadystatechange = function () {
                        if (document.readyState === "interactive") {
                            ...
                            if(window.two_load_delayed_iframe !== undefined){
                                 window.two_delayed_loading_iframe_events.forEach(function(ev) { window.two_iframe_event_listeners[ev] = document.addEventListener(ev, two_load_delayed_iframe, false) });
                            }
                        }
                    }
              </script>'));
